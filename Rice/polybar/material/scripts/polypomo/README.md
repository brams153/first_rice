...
exec = /scripts/polypomo/polypomo
tail = true

label = %output%
click-left = /scripts/polypomo/polypomo toggle
click-right = /scripts/polypomo/polypomo end
click-middle = /scripts/polypomo/polypomo lock
scroll-up = /scripts/polypomo/polypomo time +60
scroll-down = /scripts/polypomo/polypomo time -60
